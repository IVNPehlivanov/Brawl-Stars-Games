...
export default function PixelGame({ dayKey, onSolved }: Props) {
  ...
  const secretKey = getDailySecretFromPool(brawlerKeys, "pixel", dayKey);
  ...
  const imagePath = `/Brawlers/${secretKey.replace(/_/g, "-")}.webp`;
    ...
    <div className="space-y-4">
      ...
      {won && (
        <div className="text-center py-4 animate-fade-up">
          <p className="text-green-400 font-bold text-xl mb-1">🎉 {getBrawlerDisplayName(secretKey)}!</p>
