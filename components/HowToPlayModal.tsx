    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <h2 className="font-brawl text-yellow-400 text-xl mb-4">How to Play: {title}</h2>
            ...
            <button
              onClick={() => setOpen(false)}
              className="mt-6 w-full py-2 bg-yellow-400 text-gray-900 font-bold rounded-lg hover:bg-yellow-300 transition-colors"
            >
              Got it!
            </button>
          </div>
